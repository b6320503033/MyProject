...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="flex justify-between items-center h-16 bg-gray-100 text-black">
            @if (Route::has('login'))
        ...
        @foreach ($campaign as $ecampaign)
            ...
            <div class="border rounded m-1 py-1 shadow border-light col-md-3 " style="overflow: hidden;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4"><a class="btn btn-primary" href="{{ route('anonymousCampaign') }}" style="">detail&gt;</a></div>
                    <div class="col-md-4"></div>
                </div>
            </div>
